...
Python · FastAPI · Kubernetes · Docker · Helm · Prometheus · Grafana · GPU · vLLM · MLOps · CI/CD. 22/22 PR1 CPU tests; MiniCPM-SALA 9B; 24 Lightning + 8 GQA layers; vLLM 0.24. Production LLM/platform engineering focus for latency, cost, and reliability.

## Results (numbers)

| Metric | Value |
|---|---|
| Tracked repository files | **71** |
| Python modules | **27** |
| Notebooks | **0** |
| Markdown docs | **29** |
| CI workflows present | **Yes** |
| Automated tests present | **Yes** |
| Project highlights | **22/22 PR1 CPU tests; MiniCPM-SALA 9B; 24 Lightning + 8 GQA layers; vLLM 0.24** |

## Tech stack

- **Primary language:** Python
- **Languages (GitHub):** Python (237382 bytes), Shell (13046 bytes)
- **Focus area:** infra
