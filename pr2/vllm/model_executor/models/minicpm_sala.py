...
class MiniCPMSALALightningAttention(PluggableLayer, MambaBase):
    ...
    def __init__(
        ...
        if self.use_output_norm:
            self.o_norm = RMSNorm(self.hidden_inner, eps=self.rms_norm_eps)
        ...
        full_decay = build_alibi_slopes(self.num_heads) * -1.0
    ...
    def get_state_dtype(self) -> tuple[torch.dtype]:
        ...
        return MambaStateDtypeCalculator.linear_attention_state_dtype(
            torch.bfloat16, self.cache_config.mamba_cache_dtype
        )
