...
run env MINICPM_SALA_PROMPT='Briefly explain gravity:' MINICPM_SALA_DENSE_EAGER_PREFILL=0 python3 pr2/scripts/gpu_validation/diagnostics/gate1_l0_sparse_bisect.py
