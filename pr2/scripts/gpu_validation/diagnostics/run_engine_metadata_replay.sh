...
MINICPM_SALA_PROMPT='Briefly explain gravity:' \
  python3 pr2/scripts/gpu_validation/diagnostics/gate1_engine_metadata_replay.py 2>&1 \
  | tee pr2/scripts/gpu_validation/diagnostics/traces/engine_metadata_replay.log
